...
const { addCheckIn, addCheckOut, getCheckInsByRiderId, getCheckInsByCheckInId, deleteCheckIns } = require("../controllers/checkIns.controller.js");
const {upload} = require("../middlewares/multer.middleware.js");
const { authenticateRider } = require("../middlewares/authToken.middleware.js");
const { validateByRiderId, validateByCheckInId, validateCheckIn, validateCheckOut, validateDeleteRider } = require('../validators/checkIns.validator.js')
